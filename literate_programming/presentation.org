...
#+BEGIN_QUOTE
Org returns the contents of the standard output stream as text results.
#+END_QUOTE
...
(my/docker-path "minimal_python")
(my/docker-path "minimal_python" "app")
#+END_SRC
...
#+name: addhdr
#+begin_src emacs-lisp :var tbl="""Truth" "Estimate") (cons 'hline tbl)))
#+end_src
